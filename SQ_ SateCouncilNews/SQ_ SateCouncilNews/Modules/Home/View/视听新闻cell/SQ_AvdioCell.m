...
@property (nonatomic, strong)SQ_HalfVideoNewsView *newsView4;



@end
@implementation SQ_AvdioCell
...
- (void)createUI {
    ...
    self.newsView2 = [[SQ_AudioView alloc] init];
    ...
    self.newsView3 = [[SQ_HalfVideoNewsView alloc] init];
    ...
    self.newsView4 = [[SQ_HalfVideoNewsView alloc] init];
    [self.contentView addSubview:_newsView4];
    [_newsView4 makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.equalTo(_newsView2.bottom).offset(10);
        make.left.equalTo(_newsView3.right).offset(10);
        make.width.equalTo(WIDTH / 2 - 20);
        make.height.equalTo(150);
    }];
