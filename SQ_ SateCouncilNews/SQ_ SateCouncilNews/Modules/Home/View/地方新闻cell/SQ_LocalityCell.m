...
@implementation SQ_LocalityCell
...
- (void)tapAction:(UITapGestureRecognizer *)tap {
    if (tap.view == _newsView1) {
        ...
        [self.delegate localityNewsWithData:_newsView1.article];
    }
    else if (tap.view == _newsView2) {
        [self.delegate localityNewsWithData:_newsView2.article];
        
    }
    else if (tap.view == _newsView3) {
        [self.delegate localityNewsWithData:_newsView3.article];
