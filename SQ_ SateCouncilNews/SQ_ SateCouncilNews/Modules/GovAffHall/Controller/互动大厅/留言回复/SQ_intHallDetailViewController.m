//
//  SQ_intHallDetailViewController.m
//  SQ_ SateCouncilNews
//
...
@interface SQ_intHallDetailViewController ()
<
UITableViewDelegate,
...
@implementation SQ_intHallDetailViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SQ_intHallDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil) {
        
        cell = [[SQ_intHallDetailCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
