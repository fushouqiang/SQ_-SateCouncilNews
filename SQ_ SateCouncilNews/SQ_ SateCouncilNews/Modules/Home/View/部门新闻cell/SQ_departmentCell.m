...
@implementation SQ_departmentCell
...
- (void)tapAction:(UITapGestureRecognizer *)tap {
    if (tap.view == _newsView1) {
        ...
        [self.delegate departmentNewsWithData:_newsView1.article];
    }
    else if (tap.view == _newsView2) {
        [self.delegate departmentNewsWithData:_newsView2.article];
        
    }
    else if (tap.view == _newsView3) {
        [self.delegate departmentNewsWithData:_newsView3.article];
        
    }
    else if (tap.view == _newsView4) {
        [self.delegate departmentNewsWithData:_newsView4.article];
        
    }
    else if (tap.view == _newsView4) {
        [self.delegate departmentNewsWithData:_newsView5.article];
