...
@interface intHallTopCell ()

@property (nonatomic, strong) UIImageView *myImageView;

@end

@implementation intHallTopCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [writeButton setTitle:@"我要留言" forState:UIControlStateNormal];
        ...
        [writeBackButton setTitle:@"留言回复" forState:UIControlStateNormal];
        ...
        [writeSelectButton setTitle:@"留言选登" forState:UIControlStateNormal];
